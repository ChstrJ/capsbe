    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.IntegerField(default=1731131014.205999)),
                ('updated_at', models.IntegerField(default=1731131014.205999)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('created_at', models.IntegerField(default=1731131014.203998)),
                ('updated_at', models.IntegerField(default=1731131014.203998)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('created_at', models.IntegerField(default=1731131014.204998)),
                ('updated_at', models.IntegerField(default=1731131014.204998)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alert_status', models.CharField(choices=[('ongoing', 'Ongoing'), ('dismissed', 'Dismissed'), ('pending', 'Pending'), ('done', 'Done')], default='pending', max_length=100, null=True)),
                ...
                ('created_at', models.IntegerField(default=1731131014.205999)),
                ('updated_at', models.IntegerField(default=1731131014.205999)),
                ('admin', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='admins', to='api.admin')),
                ('resident', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='residents', to='api.resident')),
            ],
        ),
    ]
